...
import com.marcuschu.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "marcuschu");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.marcuschu");
